...
namespace BLE_APPLY
{
    ...
    public class BLE_APPLY_Class
    {
        ...
        /// 当前蓝牙连接状态
        /// </summary>
        public bool gBLEConStatus
        {
            get { return bleCore.ConnectStatus; }
        }
        ...
        /// 连接蓝牙
        /// </summary>
        public bool Connect(string deviceUUID)
        {
            //Windows.Devices.Bluetooth.BluetoothLEDevice bluetoothLEDevice =
            //    this.DeviceList.Where(u => u.Name == deviceName).FirstOrDefault();
            Windows.Devices.Bluetooth.BluetoothLEDevice bluetoothLEDevice =
               this.DeviceList.Where(u => u.DeviceId == deviceUUID).FirstOrDefault();
